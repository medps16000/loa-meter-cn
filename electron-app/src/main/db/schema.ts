...
-- Covers the "filter by boss + newest first" list query without a sort step.
CREATE INDEX IF NOT EXISTS idx_encounters_boss_started ON encounters(boss_name, started_at DESC);
